...
test('User should be Marc Antoine object', () => {
    expect(typeof (functions.createUser())).toBe('object');
...
test('Should be under or equal 1000', () => {
  ...
  expect(functions.checkValue(load1 + load2)).toBeLessThanOrEqual(1000);
});
...
test('reverseString function exists', () => {
  expect(reverseString("str")).toBeDefined();
});
...
test('String reverses with uppercase', () => {
  expect(reverseString("str").toUpperCase()).toEqual("RTS");
});
